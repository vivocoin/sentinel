...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to desired "gobject list" output
    ...
    def desired_serialise(self):
        import desirelib
        return desirelib.SHIM_serialise_for_desired(self.serialise())
