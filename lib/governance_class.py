...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to vivod "gobject list" output
    ...
    def vivod_serialise(self):
        import vivolib
        return vivolib.SHIM_serialise_for_vivod(self.serialise())
